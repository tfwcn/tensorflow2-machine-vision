...
```
python ./ai_api/ai_models/yolo_v3/test.py --imageFile "./data/img.png" --anchorsFile "./data/coco_anchors.txt" --classesFile "./data/coco_classes.txt" --model_path "./data/yolo_v3_weights/tf2_weights/"
```
