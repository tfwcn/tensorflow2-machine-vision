...
from ai_api.ai_models.utils.batch_norm_act import TpuBatchNormalization, BatchNormalization
from ai_api.ai_models.backbone import efficientnet_model
...
def efficientnet(width_coefficient=None,
  ...
  global_params = efficientnet_model.GlobalParams(
      ...
      batch_norm=TpuBatchNormalization,  # TPU-specific requirement.
      use_se=True,
...
def get_model_params(model_name, override_params):
  ...
  # block参数，r:重复次数，k:卷积核大小，s:步长1*1，e:扩大层与瓶颈层相反（输入通道数的百分比，为1时无操作）
  # i:输入通道数，o:输出通道数，se:瓶颈层大小（输出通道数的百分比）
  # 默认7层
  # _DEFAULT_BLOCKS_ARGS = [
  #     'r1_k3_s11_e1_i32_o16_se0.25', 'r2_k3_s22_e6_i16_o24_se0.25',
  #     'r2_k5_s22_e6_i24_o40_se0.25', 'r3_k3_s22_e6_i40_o80_se0.25',
